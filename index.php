...
<body class="body-plus">
    ...
    <div class="d-flex align-items-end flex-column bd-highlight mb-3">
        <a href="logout.php" class="m-2 p-2 bd-highligh btn btn-primary" role="button">Log out</a>
    </div>
            ...
            <!------------------ To Do List Box --------------------->
                ...
                <div class="to-do-list">
                    ...
                    <?php 
                     ...
                     $todosDB = $conn->prepare("SELECT * FROM $todosTable ORDER BY id DESC");
                     $todosDB->execute();
                     ...
                     foreach ($todos as $todo) {
                        ...
                        <div class="list-field">
                            <strong class="list-field" >'.$todo["title"].'</strong>
                            <p>'.$todo["info"].'</p>
                            <br>
                            <div>
                                <button type="submit" class="editbutton"  id="'.$todo["id"].'">Edit</button>
                                <button type="submit"  onclick="deleteTodo('.$todo["id"].')" id="'.$todo["id"].'"  class="deletebutton">Delete</button>
                            </div>
                        </div>
                        <br>
                    </li>';
